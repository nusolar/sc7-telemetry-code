...
DECLARE @type_none int,
    ...
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('PotRegen', 'RGPT', '505', @type_average, 'Regen Pedal Position', '#,##0.00;#,##0.00', @datatype_Byte8, @chart_yes, 3, @datatype_Byte8)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('PotAccel', 'ACPT', '505', @type_average, 'Accelerator Position', '#,##0.00;#,##0.00', @datatype_Byte8, @chart_yes, 2, @datatype_Byte8)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
