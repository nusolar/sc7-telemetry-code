...
DECLARE @type_none int,
	...
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('ContactorStatus', 'PCDS', '6F7', @type_none, 'Precharge Contactor Driver Status', '#,##0.00;#,##0.00', @datatype_Byte8, @chart_yes, 0, @datatype_Byte8)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('PrechargeState', 'PCS', '6F7', @type_none, 'Precharge Status', '#,##0.00;#,##0.00', @datatype_UInt16, @chart_yes, 1, @datatype_Byte8)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('ContactorVoltage', 'CVTG', '6F7', @type_average, '12V Contactor Supply Voltage', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 2, @datatype_UInt16)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
    ...
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('CurrentBus', 'IBUS', '402', @type_average, 'Bus Current', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('VoltageBus', 'VBUS', '402', @type_average, 'Bus Voltage', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('CurrentPhaseA', 'IPHA', '404', @type_average, 'Phase A Current', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('CurrentPhaseB', 'IPHB', '404', @type_average, 'Phase B Current', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('VoltageMotorImag', 'VMIM', '405', @type_average, 'Imaginary Motor Voltage', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('VoltageMotorReal', 'VMRL', '405', @type_average, 'Real Motor Voltage', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('CurrentMotorImag', 'IMIM', '406', @type_average, 'Imaginary Motor Current', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('CurrentMotorReal', 'IMRL', '406', @type_average, 'Real Motor Current', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('BackEMFMotorImag', 'EMFI', '407', @type_average, 'Imaginary Motor Back EMF', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('BackEMFMotorReal', 'EMFR', '407', @type_average, 'Real Motor Back EMF', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('VoltageFifteenVSupply', '15VS', '408', @type_average, '15 Volt Supply Voltage', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('VoltageOnePtSixtyFiveVRef', '165R', '408', @type_average, '1.65 Voltage Reference', '#,##0.00;#,##0.00', @datatype_Double, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('VoltageTwoPtFiveVSupply', '25VS', '409', @type_average, '2.5 Volt Supply Voltage', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('VoltageOnePtTwoVSupply', '12VS', '409', @type_average, '1.2 Volt Supply Voltage', '#,##0.00;#,##0.00', @datatype_Double, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('FanDriveRPM', 'FRPM', '40A', @type_average, 'Fan RPM', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('FanDrivePercent', 'FPER', '40A', @type_average, 'Fan Drive Percent', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('TempHeatsink', 'THTS', '40B', @type_average, 'Heat Sink Temperature', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('TempMotor', 'TMOT', '40B', @type_average, 'Motor Temperature', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('TempAirInlet', 'TINL', '40C', @type_average, 'Air Inlet Temperature', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('TempAirOutlet', 'TOUT', '40D', @type_average, 'Air Outlet Temperature', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('TempProcessor', 'TPRO', '40C', @type_average, 'Processor Temperature', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('TempCapacitor', 'TCAP', '40D', @type_average, 'Capacitor Temperature', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('AmpHoursDCBus', 'AMPH', '40E', @type_average, 'DC Bus Amp Hours', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('Odometer', 'ODO', '40E', @type_average, 'Odometer (Meters)', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 0, @datatype_Float)
    --INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
    ...
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('PotRegen', 'RGPT', '505', @type_average, 'Regen Pedal Position', '#,##0.00;#,##0.00', @datatype_Double, @chart_yes, 3, @datatype_Byte8)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('DCStatus', 'DCST', '505', @type_none, 'Driver Controls Status Flags', '#,##0', @datatype_UInt16, @chart_yes, 0, @datatype_UInt16)    
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('PotAccel', 'ACPT', '505', @type_average, 'Accelerator Position', '#,##0.00;#,##0.00', @datatype_Double, @chart_yes, 2, @datatype_Byte8)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('DCCANError', 'DCCE', '505', @type_none, 'Driver Controls CAN Error Flags', '#,##0', @datatype_UInt16, @chart_yes, 4, @datatype_UInt16)    
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
	                  VALUES ('DCError', 'DCER', '505', @type_none, 'Driver Controls Error Flags', '#,##0', @datatype_Byte8, @chart_yes, 6, @datatype_Byte8)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
	                  VALUES ('CarGear', 'GEAR', '505', @type_none, 'Car Gear State', '#,##0', @datatype_Byte8, @chart_yes, 7, @datatype_Byte8)
	--INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
