...
DECLARE @type_none int,
    ...
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('MC_1Pt65VSupply', '165R', '408', @type_average, '1.65 Voltage Reference', '#,##0.00;#,##0.00', @datatype_Double, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('MC_2Pt5VSupply', '25VS', '409', @type_average, '2.5 Volt Supply Voltage', '#,##0.00;#,##0.00', @datatype_Float, @chart_yes, 4, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('MC_1Pt2VSupply', '12VS', '409', @type_average, '1.2 Volt Supply Voltage', '#,##0.00;#,##0.00', @datatype_Double, @chart_yes, 0, @datatype_Float)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
	...
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('DC_Gear', 'DCGR', '505', @type_none, 'Car Gear', '#,##0.00;#,##0.00', @datatype_Byte8, @chart_yes, 5, @datatype_Byte8)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('DC_OverCurrCount', 'DOCR', '505', @type_none, 'Overcurrent Count', '#,##0.00;#,##0.00', @datatype_Int16, @chart_yes, 4, @datatype_Byte8)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
    ...
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('DC_IgnitionSwitch', 'DCST', '505', @type_none, 'Ignition Switch', '#,##0', @datatype_UInt16, @chart_yes, 0, @datatype_UInt16) 
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
	                  VALUES ('DC_StatusFlags2', 'DCS2', '506', @type_none, 'DC Status Flags 2', '#,##0', @datatype_Byte8, @chart_yes, 5, @datatype_Byte8)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
	                  VALUES ('DC_StatusFlags1', 'DCS1', '506', @type_none, 'DC Status Flags 1', '#,##0', @datatype_Byte8, @chart_yes, 4, @datatype_Byte8)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
	                  VALUES ('DC_ErrorFlags2', 'DCE2', '506', @type_none, 'DC Error Flags 2', '#,##0', @datatype_Byte8, @chart_yes, 3, @datatype_Byte8)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
	                  VALUES ('DC_ErrorFlags1', 'DCE1', '506', @type_none, 'DC Error Flags 1', '#,##0', @datatype_Byte8, @chart_yes, 2, @datatype_Byte8)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('DC_CANErrorFlags', 'DCCE', '506', @type_none, 'DC CAN Error Flags', '#,##0', @datatype_UInt16, @chart_yes, 0, @datatype_UInt16)   
	...
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('BMS_ID', 'BID', '600', @type_none, 'BMS ID', '#,##0.00;#,##0.00', @datatype_UInt32, @chart_yes, 0, @datatype_UInt32)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
	...
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('BMS_PCBTemp02', 'PB02', '604', @type_average, 'PCB 2 Temperature', '#,##0.00;#,##0.00', @datatype_Double, @chart_yes, 4, @datatype_Int16)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
	...
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('BMS_VoltageMax', 'VMAX', '6F8', @type_maximum, 'Maximum Cell Voltage (mV)', '#,##0.00;#,##0.00', @datatype_UInt16, @chart_yes, 2, @datatype_UInt16)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('BMS_VoltageMin', 'VMIN', '6F8', @type_minimum, 'Minimum Cell Voltage (mV)', '#,##0.00;#,##0.00', @datatype_UInt16, @chart_yes, 0, @datatype_UInt16)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('BMS_TempMax', 'TMAX', '6F9', @type_maximum, 'Maximum Cell Temperature', '#,##0.00;#,##0.00', @datatype_UInt16, @chart_yes, 2, @datatype_UInt16)
    INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
                      VALUES ('BMS_TempMin', 'TMIN', '6F9', @type_minimum, 'Minimum Cell Temperature', '#,##0.00;#,##0.00', @datatype_UInt16, @chart_yes, 0, @datatype_UInt16)
	INSERT INTO tblDataItems (FieldName, Tag, CANTag, SummaryType, Description, DisplayFormat, DataType, NoCharting, CANByteOffset, CANDataType)
